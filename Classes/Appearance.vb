Module Appearance
    ...
    Private Sub AssignMode()
        ...
        'Editor_Index
        AssignColor(Editor_Index.TitleBarPanel, "TitleBar")
        AssignColor(Editor_Index.TitleLabel, "TitleBar")
        AssignColor(Editor_Index.BackgroundPanel, "Background")
        AssignColor(Editor_Index.CloseButton, "TitleButton")
        AssignColor(Editor_Index.CloseText, "TitleButton")
        AssignColor(Editor_Index.EditorPanel, "Pages")
        AssignColor(Editor_Index.CatLabel, "Pages")
        AssignColor(Editor_Index.CatText, "Pages")
        AssignColor(Editor_Index.DescLabel, "Pages")
        AssignColor(Editor_Index.DescText, "Pages")
        AssignColor(Editor_Index.AvailLabel, "Pages")
        AssignColor(Editor_Index.AvailCheck, "Pages")
        AssignColor(Editor_Index.IndexSaveButton, "Button")
        AssignColor(Editor_Index.IndexCancelButton, "Button")
        AssignColor(Editor_Index.LowText, "Pages")

        'EditorAbl
        AssignColor(EditorAbl.TitleBarPanel, "TitleBar")
        AssignColor(EditorAbl.TitleLabel, "TitleBar")
        AssignColor(EditorAbl.BackgroundPanel, "Background")
        AssignColor(EditorAbl.CloseButton, "TitleButton")
        AssignColor(EditorAbl.CloseText, "TitleButton")
        AssignColor(EditorAbl.EditorPanel, "Pages")
        AssignColor(EditorAbl.AblLabel, "Pages")
        AssignColor(EditorAbl.AblText, "Pages")
        AssignColor(EditorAbl.DescLabel, "Pages")
        AssignColor(EditorAbl.DescText, "Pages")
        AssignColor(EditorAbl.TypeLabel, "Pages")
        AssignColor(EditorAbl.TypeDrop, "Pages")
        AssignColor(EditorAbl.Cost1Text, "Pages")
        AssignColor(EditorAbl.Cost1Drop, "Pages")
        AssignColor(EditorAbl.Cost2Button, "Button")
        AssignColor(EditorAbl.Cost2Text, "Pages")
        AssignColor(EditorAbl.Cost2Drop, "Pages")
        AssignColor(EditorAbl.Cost3Button, "Button")
        AssignColor(EditorAbl.Cost3Text, "Pages")
        AssignColor(EditorAbl.Cost3Drop, "Pages")
        AssignColor(EditorAbl.TargetLabel, "Pages")
        AssignColor(EditorAbl.SelfCheck, "Pages")
        AssignColor(EditorAbl.AllyCheck, "Pages")
        AssignColor(EditorAbl.EnemyCheck, "Pages")
        AssignColor(EditorAbl.MultiCheck, "Pages")
        AssignColor(EditorAbl.AllCheck, "Pages")
        AssignColor(EditorAbl.Impact1Text, "Pages")
        AssignColor(EditorAbl.Impact1Drop, "Pages")
        AssignColor(EditorAbl.Impact2Button, "Button")
        AssignColor(EditorAbl.Impact2Text, "Pages")
        AssignColor(EditorAbl.Impact2Drop, "Pages")
        AssignColor(EditorAbl.Impact3Button, "Button")
        AssignColor(EditorAbl.Impact3Text, "Pages")
        AssignColor(EditorAbl.Impact3Drop, "Pages")
        AssignColor(EditorAbl.ElemLabel, "Pages")
        AssignColor(EditorAbl.ElemDrop, "Pages")
        AssignColor(EditorAbl.EffLabel, "Pages")
        AssignColor(EditorAbl.EffList, "Pages")
        AssignColor(EditorAbl.MultiLabel, "Pages")
        AssignColor(EditorAbl.Prof1Text, "Pages")
        AssignColor(EditorAbl.Prof1Drop, "Pages")
        AssignColor(EditorAbl.Prof2Button, "Button")
        AssignColor(EditorAbl.Prof2Text, "Pages")
        AssignColor(EditorAbl.Prof2Drop, "Pages")
        AssignColor(EditorAbl.Prof3Button, "Button")
        AssignColor(EditorAbl.Prof3Text, "Pages")
        AssignColor(EditorAbl.Prof3Drop, "Pages")
        AssignColor(EditorAbl.AblSaveButton, "Button")
        AssignColor(EditorAbl.AblCancelButton, "Button")
        ...
        AssignColor(Optioner.MusicFileText, "Pages")
        AssignColor(Optioner.MusicFileLenText, "Pages")
        AssignColor(Optioner.MusicPlayButton, "Button")
        AssignColor(Optioner.MusicStopButton, "Button")
        AssignColor(Optioner.MusicTopText, "Pages")
        AssignColor(Optioner.MusicMainLabel, "Pages")
        AssignColor(Optioner.MusicMainText, "Pages")
        AssignColor(Optioner.MusicMainButton, "Button")
        AssignColor(Optioner.MusicBattleLabel, "Pages")
        AssignColor(Optioner.MusicBattleText, "Pages")
        AssignColor(Optioner.MusicBattleButton, "Button")
        AssignColor(Optioner.MusicVictoryLabel, "Pages")
        AssignColor(Optioner.MusicVictoryText, "Pages")
        AssignColor(Optioner.MusicVictoryButton, "Button")
        AssignColor(Optioner.MusicDefeatLabel, "Pages")
        AssignColor(Optioner.MusicDefeatText, "Pages")
        AssignColor(Optioner.MusicDefeatButton, "Button")
        AssignColor(Optioner.MusicLowText, "Pages")
        AssignColor(Optioner.MusicOnButton, "Button")
        AssignColor(Optioner.MusicOffButton, "Button")
        AssignColor(Optioner.MusicResetButton, "Button")
    End Sub
